...
TEST(RepeatedSquaringTest, ExampleCormen){
    ...
    ASSERT_EQ(7, repeated_squaring_result->distance[2][0]);
    ASSERT_EQ(4, repeated_squaring_result->distance[2][1]);
    ASSERT_EQ(0, repeated_squaring_result->distance[2][2]);
    ASSERT_EQ(5, repeated_squaring_result->distance[2][3]);
    ASSERT_EQ(3, repeated_squaring_result->distance[2][4]);
    ASSERT_EQ(2, repeated_squaring_result->distance[3][0]);
    ASSERT_EQ(-1, repeated_squaring_result->distance[3][1]);
    ...
    ASSERT_EQ(2, repeated_squaring_result->predecessor[0][1]);
    ...
    ASSERT_EQ(3, repeated_squaring_result->predecessor[2][0]);
    ASSERT_EQ(2, repeated_squaring_result->predecessor[2][1]);
    ASSERT_EQ(PREDECESSOR_NULL, repeated_squaring_result->predecessor[2][2]);
    ASSERT_EQ(1, repeated_squaring_result->predecessor[2][3]);
    ASSERT_EQ(0, repeated_squaring_result->predecessor[2][4]);
...
TEST(RepeatedSquaringTest, Example2){
    ...
    repeated_squaring_result = repeated_squaring(&graph);
    ASSERT_EQ(0, repeated_squaring_result->distance[0][0]);
    ASSERT_EQ(4, repeated_squaring_result->distance[0][1]);
    ASSERT_EQ(7, repeated_squaring_result->distance[0][2]);
    ASSERT_EQ(3, repeated_squaring_result->distance[0][3]);
    ASSERT_EQ(4, repeated_squaring_result->distance[0][4]);
    ASSERT_EQ(10, repeated_squaring_result->distance[1][0]);
    ASSERT_EQ(0, repeated_squaring_result->distance[1][1]);
    ASSERT_EQ(3, repeated_squaring_result->distance[1][2]);
    ASSERT_EQ(9, repeated_squaring_result->distance[1][3]);
    ASSERT_EQ(8, repeated_squaring_result->distance[1][4]);
    ASSERT_EQ(7, repeated_squaring_result->distance[2][0]);
    ASSERT_EQ(6, repeated_squaring_result->distance[2][1]);
    ASSERT_EQ(0, repeated_squaring_result->distance[2][2]);
    ASSERT_EQ(6, repeated_squaring_result->distance[2][3]);
    ASSERT_EQ(5, repeated_squaring_result->distance[2][4]);
    ASSERT_EQ(1, repeated_squaring_result->distance[3][0]);
    ASSERT_EQ(1, repeated_squaring_result->distance[3][1]);
    ASSERT_EQ(4, repeated_squaring_result->distance[3][2]);
    ASSERT_EQ(0, repeated_squaring_result->distance[3][3]);
    ASSERT_EQ(1, repeated_squaring_result->distance[3][4]);
    ASSERT_EQ(2, repeated_squaring_result->distance[4][0]);
    ASSERT_EQ(1, repeated_squaring_result->distance[4][1]);
